...
exports.httpSend = function(protocol, host, endpoint, method, contentType, dataString){
    ...
    this.httpSendHeaders(protocol, host, endpoint, method, headers, dataString);
}

exports.httpSendHeaders = function(protocol, host, endpoint, method, headers, dataString){
