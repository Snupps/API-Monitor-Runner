...
var resultHandler = require('./results.js');
...
exports.runFrisbyjsTests = function(callback){
    ...
    var command = __dirname+'/../node_modules/.bin/jasmine-node  --junitreport --output '+result_output_dir+' --config FRISBY_PATH '+frisby_path+' '+repo_path;
...
exports.getResults = function(callback){
    ...
    result_file_list.forEach(function(item){
        ...
        if(shell.test('-e', result_output_dir+item)){
            ...
            resultHandler.setXmlResults(str);
            resultHandler.parse();
    ...
    callback(null,result_file_list);
};